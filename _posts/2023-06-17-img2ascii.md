...
若要将ASCII图像利用HTML文件进行展示，可以利用较粗的等宽字体展示，效果如前文图片所示。代码中用到的字体可在<a href="/fonts/Topaz/Topaz-8.ttf">此处下载<i class="fas fa-download"></i></a>
...
输出分辨率`OutPic_lateral_res`的设置会影响ASCII字符画的可辨识度，当`OutPic_lateral_res`分别取192，128，96，64时的输出图片与原图对比如下。
