...
$$\mathrm{Area}(r)=\begin{cases}4\pi r^2&0<r\leq\frac{\ell}{2}\\2\pi(3r\ell-4r^2)&\frac{\ell}{2}<r\leq\frac{\sqrt2}{2}\ell\\2\pi(3r\ell-4r^2)+24r\left[r\cos^{-1}\left(\frac{\ell^2}{4r^2-\ell^2}\right)-\cos^{-1}\left(\frac{\ell}{\sqrt{4r^2-\ell^2}}\right)\right]&\frac{\sqrt2}{2}\ell<r\leq\frac{\sqrt3}{2}\ell\end{cases}$$
