...
article_header:
  actions:
    ...
    - text: Learn More <i class="fas fa-angle-double-down"></i>
      ...
      url: /chemistry-collections/PhoRaCC.html#使用说明
  height: 100vh
  theme: dark
...
PhoRaCC (**Pho**tophysical **Ra**te **C**onstants **C**alculator)旨在简化使用瞬态光致发光数据计算光物理常数的流程。PhoRaCC提供多种算法来适应各种场景，且具有直观的操作界面，使用户能够快速获得准确的结果。
