...
<center><p class="info">Drag to resize images<br>Small<input type="range" id="scale_img" min="50" max="300" value="50" step="5" oninput="Scale()" onchange="Scale()" style="width: 30%;">Large</p></center>
